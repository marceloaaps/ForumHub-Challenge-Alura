...
public class CriarTopicoUseCase {
    ...
    private final VerificarTopicoCriado verificarTopicoCriado;

    public CriarTopicoUseCase(TopicoRepository repository) {
        this.repository = repository;
        this.verificarTopicoCriado = new VerificarTopicoCriado();
    }
    ...
    public void criarTopico(TopicoDto topicoDto) {
        ...
        if (verificarTopicoCriado.verificaTopicoTitulo(topicoDto)){
            throw new ExistingTitleException(topicoDto.titulo());
        }

        if (verificarTopicoCriado.verificaTopicoMensagem(topicoDto) ){
